...
def test_execution_parser_accepts_stock_trade_0a_and_rejects_priority_quote_0b():
    output = _run(
        r'''
...
def test_execution_subscription_uses_configured_0a_type():
    output = _run(
        r'''
from types import SimpleNamespace
from realtime_v2 import worker_aux_metric_source_contract_patch as contract
...
def test_strength_parser_relabels_intraday_tr_as_ka10045():
    output = _run(
        r'''
from realtime_v2 import worker_aux_metric_source_contract_patch as contract
