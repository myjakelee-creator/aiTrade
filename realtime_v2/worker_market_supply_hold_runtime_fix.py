...
def install() -> None:
    ...
    from realtime_v2.worker_trade_field_regression_guard import (
        install as install_trade_field_regression_guard,
    )
    ...
    if guard_base is not None:
        ...
        install_trade_field_regression_guard(guard_base)
